    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setReserr("Server Error or Appliation Error ");
            }
        } catch (error) {
                    ...
                    <div className="flex flex-col justify-center items-center border w-full lg:w-1/2">
                        <div>
                            ...
                            <form onSubmit={handleSubmit} to="/pricing" className="mt-10 w-[80%] lg:w-96 mx-auto space-y-4">
                                ...
                                <div className="flex gap-4">
                                    <input type="text" name="mnumber" value={mnumber} onChange={(e) => setMnumber(e.target.value)} placeholder="Mobile Number" className="border w-full px-4 py-2 rounded-md" id="" />
                                    <input type="text" name="aadharr" value={aadharr} onChange={(e) => setAadharr(e.target.value)} placeholder="Aadhar Number" className="border w-full px-4 py-2 rounded-md" id="" />
                                </div>
